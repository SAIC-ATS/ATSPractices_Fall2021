<template>
  ...
  >
    <NuxtLink
      ...
      class="text-primary-500 font-bold hover:underline flex items-center justify-start z-40"
    >
    ...
    <NuxtLink
      ...
      class="text-primary-500 font-bold hover:underline flex items-center justify-end z-40"
    >
