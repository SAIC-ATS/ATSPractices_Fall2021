...
__webpack_require__.d(components_namespaceObject, "AppGithubLink", function() { return AppGithubLink; });
...
__webpack_require__.d(components_namespaceObject, "Student", function() { return Student; });
...
const _36d5b094 = () => interopDefault(__webpack_require__.e(/* import() | pages/releases */ 29).then(__webpack_require__.bind(null, 88)));

const _2fa33272 = () => interopDefault(__webpack_require__.e(/* import() | pages/_ */ 28).then(__webpack_require__.bind(null, 89)));
...
const AppColorSwitcher = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 18)).then(c => wrapFunctional(c.default || c));
const Alert = () => __webpack_require__.e(/* import() | components/alert */ 2).then(__webpack_require__.bind(null, 90)).then(c => wrapFunctional(c.default || c));
const Badge = () => __webpack_require__.e(/* import() | components/badge */ 8).then(__webpack_require__.bind(null, 74)).then(c => wrapFunctional(c.default || c));
const CodeBlock = () => __webpack_require__.e(/* import() | components/code-block */ 11).then(__webpack_require__.bind(null, 91)).then(c => wrapFunctional(c.default || c));
const CodeGroup = () => __webpack_require__.e(/* import() | components/code-group */ 12).then(__webpack_require__.bind(null, 92)).then(c => wrapFunctional(c.default || c));
const CodeSandbox = () => __webpack_require__.e(/* import() | components/code-sandbox */ 13).then(__webpack_require__.bind(null, 93)).then(c => wrapFunctional(c.default || c));
const List = () => __webpack_require__.e(/* import() | components/list */ 25).then(__webpack_require__.bind(null, 94)).then(c => wrapFunctional(c.default || c));
const BuiltWithNuxtDark = () => __webpack_require__.e(/* import() | components/built-with-nuxt-dark */ 9).then(__webpack_require__.bind(null, 99)).then(c => wrapFunctional(c.default || c));
const BuiltWithNuxtLight = () => __webpack_require__.e(/* import() | components/built-with-nuxt-light */ 10).then(__webpack_require__.bind(null, 100)).then(c => wrapFunctional(c.default || c));
const IconArrowLeft = () => __webpack_require__.e(/* import() | components/icon-arrow-left */ 15).then(__webpack_require__.bind(null, 61)).then(c => wrapFunctional(c.default || c));
const IconArrowRight = () => __webpack_require__.e(/* import() | components/icon-arrow-right */ 16).then(__webpack_require__.bind(null, 62)).then(c => wrapFunctional(c.default || c));
const IconBadgeCheck = () => __webpack_require__.e(/* import() | components/icon-badge-check */ 17).then(__webpack_require__.bind(null, 101)).then(c => wrapFunctional(c.default || c));
const IconCheckCircle = () => __webpack_require__.e(/* import() | components/icon-check-circle */ 18).then(__webpack_require__.bind(null, 102)).then(c => wrapFunctional(c.default || c));
const IconChevronRight = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 51)).then(c => wrapFunctional(c.default || c));
const IconClipboardCheck = () => __webpack_require__.e(/* import() | components/icon-clipboard-check */ 19).then(__webpack_require__.bind(null, 59)).then(c => wrapFunctional(c.default || c));
const IconClipboardCopy = () => __webpack_require__.e(/* import() | components/icon-clipboard-copy */ 20).then(__webpack_require__.bind(null, 60)).then(c => wrapFunctional(c.default || c));
const IconExclamationCircle = () => __webpack_require__.e(/* import() | components/icon-exclamation-circle */ 21).then(__webpack_require__.bind(null, 103)).then(c => wrapFunctional(c.default || c));
const IconExternalLink = () => __webpack_require__.e(/* import() | components/icon-external-link */ 22).then(__webpack_require__.bind(null, 63)).then(c => wrapFunctional(c.default || c));
const IconGithub = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 20)).then(c => wrapFunctional(c.default || c));
const IconInformationCircle = () => __webpack_require__.e(/* import() | components/icon-information-circle */ 23).then(__webpack_require__.bind(null, 104)).then(c => wrapFunctional(c.default || c));
const IconMenu = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 49)).then(c => wrapFunctional(c.default || c));
const IconMoon = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 47)).then(c => wrapFunctional(c.default || c));
const IconSearch = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 50)).then(c => wrapFunctional(c.default || c));
const IconSun = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 46)).then(c => wrapFunctional(c.default || c));
const IconTranslate = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52)).then(c => wrapFunctional(c.default || c));
const IconTwitter = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 19)).then(c => wrapFunctional(c.default || c));
const IconX = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 48)).then(c => wrapFunctional(c.default || c));
const IconXCircle = () => __webpack_require__.e(/* import() | components/icon-x-circle */ 24).then(__webpack_require__.bind(null, 105)).then(c => wrapFunctional(c.default || c));
const AppCopyButton = () => __webpack_require__.e(/* import() | components/app-copy-button */ 3).then(__webpack_require__.bind(null, 71)).then(c => wrapFunctional(c.default || c));
const AppDropdown = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 42)).then(c => wrapFunctional(c.default || c));
const AppFooter = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 45)).then(c => wrapFunctional(c.default || c));
const AppGithubLink = () => __webpack_require__.e(/* import() | components/app-github-link */ 4).then(__webpack_require__.bind(null, 72)).then(c => wrapFunctional(c.default || c));
const AppHeader = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 16)).then(c => wrapFunctional(c.default || c));
const AppLangSwitcher = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 17)).then(c => wrapFunctional(c.default || c));
const AppNav = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 43)).then(c => wrapFunctional(c.default || c));
const AppPrevNext = () => __webpack_require__.e(/* import() | components/app-prev-next */ 5).then(__webpack_require__.bind(null, 73)).then(c => wrapFunctional(c.default || c));
const AppSearch = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 44)).then(c => wrapFunctional(c.default || c));
const AppSearchAlgolia = () => __webpack_require__.e(/* import() | components/app-search-algolia */ 6).then(__webpack_require__.bind(null, 98)).then(c => wrapFunctional(c.default || c));
const AppToc = () => __webpack_require__.e(/* import() | components/app-toc */ 7).then(__webpack_require__.bind(null, 58)).then(c => wrapFunctional(c.default || c));
const About = () => __webpack_require__.e(/* import() | components/about */ 1).then(__webpack_require__.bind(null, 95)).then(c => wrapFunctional(c.default || c));
const Home = () => __webpack_require__.e(/* import() | components/home */ 14).then(__webpack_require__.bind(null, 96)).then(c => wrapFunctional(c.default || c));
const Student = () => __webpack_require__.e(/* import() | components/student */ 26).then(__webpack_require__.bind(null, 97)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
