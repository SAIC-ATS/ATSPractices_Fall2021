...
// Module
exports.push([module.i, "button[data-v-7e177a39]{outline:none}.highlight-underline[data-v-7e177a39]{--bg-opacity:1;background-color:#a01a58;background-color:rgba(160,26,88,var(--bg-opacity));position:absolute;bottom:-2px;height:2px;transition:left .15s,width .15s}.code-group[data-v-7e177a39]  pre[class*=language-]{border-top-left-radius:0;border-top-right-radius:0;margin-top:0}", ""]);
// Exports
